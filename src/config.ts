...
const DEFAULT_AI_CONFIG: AIConfig = {
  ...
  conversation_governance_enabled: true,
  conversation_busy_max_sentences: 1,
  conversation_clarify_ambiguous: true,
  multimodal_grounding_strict: true,
  fact_freshness_strict: true,
  memory_layering_enabled: true,
  max_tokens: 1600,
  temperature: 0.92,
  ...
  sticker_auto_reply_probability: 0.18,
  sticker_auto_group_cooldown_seconds: 45,
  sticker_auto_keyword_cooldown_seconds: 180,
  gift_voice_enabled: true,
  gift_voice_probability: 0.28,
  gift_voice_cooldown_seconds: 180,
  gift_voice_min_combo_events: 2,
  gift_voice_min_total_count: 8,
  cooldown_seconds: 0,
...
function normalizeAiConfig(value: unknown): AIConfig {
  ...
  return {
    ...
    conversation_governance_enabled: asBoolean(raw.conversation_governance_enabled, DEFAULT_AI_CONFIG.conversation_governance_enabled !== false),
    conversation_busy_max_sentences: Math.floor(asNumber(raw.conversation_busy_max_sentences, DEFAULT_AI_CONFIG.conversation_busy_max_sentences ?? 1, 1, 4)),
    conversation_clarify_ambiguous: asBoolean(raw.conversation_clarify_ambiguous, DEFAULT_AI_CONFIG.conversation_clarify_ambiguous !== false),
    multimodal_grounding_strict: asBoolean(raw.multimodal_grounding_strict, DEFAULT_AI_CONFIG.multimodal_grounding_strict !== false),
    fact_freshness_strict: asBoolean(raw.fact_freshness_strict, DEFAULT_AI_CONFIG.fact_freshness_strict !== false),
    memory_layering_enabled: asBoolean(raw.memory_layering_enabled, DEFAULT_AI_CONFIG.memory_layering_enabled !== false),
    ...
    sticker_auto_reply_enabled: asBoolean(raw.sticker_auto_reply_enabled, DEFAULT_AI_CONFIG.sticker_auto_reply_enabled !== false),
    sticker_auto_reply_probability: asNumber(raw.sticker_auto_reply_probability, DEFAULT_AI_CONFIG.sticker_auto_reply_probability ?? 0.18, 0, 1),
    sticker_auto_group_cooldown_seconds: Math.floor(asNumber(raw.sticker_auto_group_cooldown_seconds, DEFAULT_AI_CONFIG.sticker_auto_group_cooldown_seconds ?? 45, 0, 3600)),
    sticker_auto_keyword_cooldown_seconds: Math.floor(asNumber(raw.sticker_auto_keyword_cooldown_seconds, DEFAULT_AI_CONFIG.sticker_auto_keyword_cooldown_seconds ?? 180, 0, 86400)),
    gift_voice_enabled: asBoolean(raw.gift_voice_enabled, DEFAULT_AI_CONFIG.gift_voice_enabled !== false),
    gift_voice_probability: asNumber(raw.gift_voice_probability, DEFAULT_AI_CONFIG.gift_voice_probability ?? 0.28, 0, 1),
    gift_voice_cooldown_seconds: Math.floor(asNumber(raw.gift_voice_cooldown_seconds, DEFAULT_AI_CONFIG.gift_voice_cooldown_seconds ?? 180, 0, 3600)),
    gift_voice_min_combo_events: Math.floor(asNumber(raw.gift_voice_min_combo_events, DEFAULT_AI_CONFIG.gift_voice_min_combo_events ?? 2, 1, 20)),
    gift_voice_min_total_count: Math.floor(asNumber(raw.gift_voice_min_total_count, DEFAULT_AI_CONFIG.gift_voice_min_total_count ?? 8, 1, 9999)),
    cooldown_seconds: Math.floor(asNumber(raw.cooldown_seconds, DEFAULT_AI_CONFIG.cooldown_seconds, 0, 3600)),
    human_reply_delay_enabled: envBoolean('WANJIER_HUMAN_REPLY_DELAY_ENABLED') ?? asBoolean(raw.human_reply_delay_enabled, DEFAULT_AI_CONFIG.human_reply_delay_enabled !== false),
    human_reply_delay_min_ms: Math.floor(asNumber(envNumber('WANJIER_HUMAN_REPLY_DELAY_MIN_MS') ?? raw.human_reply_delay_min_ms, DEFAULT_AI_CONFIG.human_reply_delay_min_ms ?? 250, 0, 10000)),
    human_reply_delay_max_ms: Math.floor(asNumber(envNumber('WANJIER_HUMAN_REPLY_DELAY_MAX_MS') ?? raw.human_reply_delay_max_ms, DEFAULT_AI_CONFIG.human_reply_delay_max_ms ?? 1400, 0, 15000)),
    human_reply_delay_forced_min_ms: Math.floor(asNumber(envNumber('WANJIER_HUMAN_REPLY_DELAY_FORCED_MIN_MS') ?? raw.human_reply_delay_forced_min_ms, DEFAULT_AI_CONFIG.human_reply_delay_forced_min_ms ?? 120, 0, 10000)),
    human_reply_delay_forced_max_ms: Math.floor(asNumber(envNumber('WANJIER_HUMAN_REPLY_DELAY_FORCED_MAX_MS') ?? raw.human_reply_delay_forced_max_ms, DEFAULT_AI_CONFIG.human_reply_delay_forced_max_ms ?? 650, 0, 15000)),
    ...
    ai_reply_cache_max_entries: Math.floor(asNumber(raw.ai_reply_cache_max_entries, DEFAULT_AI_CONFIG.ai_reply_cache_max_entries || 300, 20, 5000)),
