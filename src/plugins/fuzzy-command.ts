...
const FUZZY_RULES: FuzzyRule[] = [
  ...
  {
    key: 'cseconomy',
    exact: ['今日经济局', '每日经济局', '抽经济局', '今天经济怎么打', '今天怎么买', '今天起什么枪', '来个经济局'],
    pairs: [
      { left: ['今日', '每日', '今天', '抽', '来个'], right: ['经济局', '经济', '怎么买', '起什么枪', 'eco'] },
    ],
  },
  {
    key: 'csshotcall',
    exact: ['今日指挥', '每日指挥', '今日口令', '每日口令', '今日指挥口令', '来个指挥口令', '今天怎么指挥'],
    pairs: [
      { left: ['今日', '每日', '今天', '抽', '来个'], right: ['指挥', '口令', '指挥口令', '怎么指挥'] },
    ],
  },
  {
    key: 'csreview',
    exact: ['今日复盘', '每日复盘', '今日demo', '每日demo', '今日切片', '每日切片', '来个复盘切片', '今天复盘什么'],
    pairs: [
      { left: ['今日', '每日', '今天', '抽', '来个'], right: ['复盘', 'demo', '切片', '复盘切片'] },
    ],
  },
  {
    key: 'csknife',
  ...
  {
    key: 'dailymovie',
    exact: ['每日影视台词', '今日影视台词', '影视台词', '来句台词', '今天影视', '每日台词', '今日台词', '电影台词', '剧台词'],
    pairs: [
      { left: ['今日', '每日', '今天', '来个', '给我', '来句'], right: ['台词', '影视', '电影', '剧台词', '经典台词', '影视台词'] },
    ],
  },
  {
    key: 'dailymusic',
    exact: ['每日音乐知识', '今日音乐知识', '音乐知识', '来个音乐知识', '今天音乐', '音乐冷知识', '音乐小知识', '乐理知识'],
    pairs: [
      { left: ['今日', '每日', '今天', '来个', '给我'], right: ['音乐知识', '乐理', '音乐冷知识', '音乐小知识', '音乐科普'] },
    ],
  },
  {
    key: 'dailyhistory',
    exact: ['历史上的今天', '历史今天', '今天历史', '每日历史', '来个历史', '今日历史'],
    pairs: [
      { left: ['今日', '每日', '今天', '来个', '给我'], right: ['历史', '历史今天', '历史上的今天', '历史事件'] },
    ],
  },
  {
    key: 'dailyscience',
    exact: ['每日科学', '今日科学', '科学知识', '来个科学知识', '科普知识', '科学小知识'],
    pairs: [
      { left: ['今日', '每日', '今天', '来个', '给我'], right: ['科学', '科普', '科学知识', '科学小知识', '科普知识'] },
    ],
  },
  {
    key: 'dailyduel',
